...
import com.example.workzyapp.ConversationModel;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.example.workzydb.ConversationAdapter adapter = new com.example.workzydb.ConversationAdapter(conversationList);
